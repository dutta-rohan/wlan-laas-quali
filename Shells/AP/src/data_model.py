...
class Ap(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'Ap'
        self._name = name
    ...
    def create_from_context(cls, context):
        ...
        :rtype Ap
        """
        result = Ap(name=context.resource.name)
    ...
    def user(self):
        ...
        :rtype: str
        """
        return self.attributes['Ap.User'] if 'Ap.User' in self.attributes else None
    ...
    def password(self):
        ...
        :rtype: string
        """
        return self.attributes['Ap.Password'] if 'Ap.Password' in self.attributes else None
    ...
    def password(self, value):
        ...
        :type value: string
        """
        self.attributes['Ap.Password'] = value
    ...
    def enable_password(self):
        ...
        :rtype: string
        """
        return self.attributes['Ap.Enable Password'] if 'Ap.Enable Password' in self.attributes else None
    ...
    def enable_password(self, value):
        ...
        :type value: string
        """
        self.attributes['Ap.Enable Password'] = value
    ...
    def power_management(self):
        ...
        :rtype: bool
        """
        return self.attributes['Ap.Power Management'] if 'Ap.Power Management' in self.attributes else None
    ...
    def power_management(self, value=True):
        ...
        :type value: bool
        """
        self.attributes['Ap.Power Management'] = value
    ...
    def sessions_concurrency_limit(self):
        ...
        :rtype: float
        """
        return self.attributes['Ap.Sessions Concurrency Limit'] if 'Ap.Sessions Concurrency Limit' in self.attributes else None
    ...
    def sessions_concurrency_limit(self, value='1'):
        ...
        :type value: float
        """
        self.attributes['Ap.Sessions Concurrency Limit'] = value
    ...
    def snmp_read_community(self):
        ...
        :rtype: string
        """
        return self.attributes['Ap.SNMP Read Community'] if 'Ap.SNMP Read Community' in self.attributes else None
    ...
    def snmp_read_community(self, value):
        ...
        :type value: string
        """
        self.attributes['Ap.SNMP Read Community'] = value
    ...
    def snmp_write_community(self):
        ...
        :rtype: string
        """
        return self.attributes['Ap.SNMP Write Community'] if 'Ap.SNMP Write Community' in self.attributes else None
    ...
    def snmp_write_community(self, value):
        ...
        :type value: string
        """
        self.attributes['Ap.SNMP Write Community'] = value
    ...
    def snmp_v3_user(self):
        ...
        :rtype: str
        """
        return self.attributes['Ap.SNMP V3 User'] if 'Ap.SNMP V3 User' in self.attributes else None
    ...
    def snmp_v3_user(self, value):
        ...
        :type value: str
        """
        self.attributes['Ap.SNMP V3 User'] = value
    ...
    def snmp_v3_password(self):
        ...
        :rtype: string
        """
        return self.attributes['Ap.SNMP V3 Password'] if 'Ap.SNMP V3 Password' in self.attributes else None
    ...
    def snmp_v3_password(self, value):
        ...
        :type value: string
        """
        self.attributes['Ap.SNMP V3 Password'] = value
    ...
    def snmp_v3_private_key(self):
        ...
        :rtype: str
        """
        return self.attributes['Ap.SNMP V3 Private Key'] if 'Ap.SNMP V3 Private Key' in self.attributes else None
    ...
    def snmp_v3_private_key(self, value):
        ...
        :type value: str
        """
        self.attributes['Ap.SNMP V3 Private Key'] = value
    ...
    def snmp_v3_authentication_protocol(self):
        ...
        :rtype: str
        """
        return self.attributes['Ap.SNMP V3 Authentication Protocol'] if 'Ap.SNMP V3 Authentication Protocol' in self.attributes else None
    ...
    def snmp_v3_authentication_protocol(self, value='No Authentication Protocol'):
        ...
        :type value: str
        """
        self.attributes['Ap.SNMP V3 Authentication Protocol'] = value
    ...
    def snmp_v3_privacy_protocol(self):
        ...
        :rtype: str
        """
        return self.attributes['Ap.SNMP V3 Privacy Protocol'] if 'Ap.SNMP V3 Privacy Protocol' in self.attributes else None
    ...
    def snmp_v3_privacy_protocol(self, value='No Privacy Protocol'):
        ...
        :type value: str
        """
        self.attributes['Ap.SNMP V3 Privacy Protocol'] = value
    ...
    def snmp_version(self):
        ...
        :rtype: str
        """
        return self.attributes['Ap.SNMP Version'] if 'Ap.SNMP Version' in self.attributes else None
    ...
    def snmp_version(self, value=''):
        ...
        :type value: str
        """
        self.attributes['Ap.SNMP Version'] = value
    ...
    def enable_snmp(self):
        ...
        :rtype: bool
        """
        return self.attributes['Ap.Enable SNMP'] if 'Ap.Enable SNMP' in self.attributes else None
    ...
    def enable_snmp(self, value=True):
        ...
        :type value: bool
        """
        self.attributes['Ap.Enable SNMP'] = value
    ...
    def disable_snmp(self):
        ...
        :rtype: bool
        """
        return self.attributes['Ap.Disable SNMP'] if 'Ap.Disable SNMP' in self.attributes else None
    ...
    def disable_snmp(self, value=False):
        ...
        :type value: bool
        """
        self.attributes['Ap.Disable SNMP'] = value
    ...
    def console_server_ip_address(self):
        ...
        :rtype: str
        """
        return self.attributes['Ap.Console Server IP Address'] if 'Ap.Console Server IP Address' in self.attributes else None
    ...
    def console_server_ip_address(self, value):
        ...
        :type value: str
        """
        self.attributes['Ap.Console Server IP Address'] = value
    ...
    def console_user(self):
        ...
        :rtype: str
        """
        return self.attributes['Ap.Console User'] if 'Ap.Console User' in self.attributes else None
    ...
    def console_user(self, value):
        ...
        :type value: str
        """
        self.attributes['Ap.Console User'] = value
    ...
    def console_port(self):
        ...
        :rtype: float
        """
        return self.attributes['Ap.Console Port'] if 'Ap.Console Port' in self.attributes else None
    ...
    def console_port(self, value):
        ...
        :type value: float
        """
        self.attributes['Ap.Console Port'] = value
    ...
    def console_password(self):
        ...
        :rtype: string
        """
        return self.attributes['Ap.Console Password'] if 'Ap.Console Password' in self.attributes else None
    ...
    def console_password(self, value):
        ...
        :type value: string
        """
        self.attributes['Ap.Console Password'] = value
    ...
    def cli_connection_type(self):
        ...
        :rtype: str
        """
        return self.attributes['Ap.CLI Connection Type'] if 'Ap.CLI Connection Type' in self.attributes else None
    ...
    def cli_connection_type(self, value='Auto'):
        ...
        :type value: str
        """
        self.attributes['Ap.CLI Connection Type'] = value
    ...
    def cli_tcp_port(self):
        ...
        :rtype: float
        """
        return self.attributes['Ap.CLI TCP Port'] if 'Ap.CLI TCP Port' in self.attributes else None
    ...
    def cli_tcp_port(self, value):
        ...
        :type value: float
        """
        self.attributes['Ap.CLI TCP Port'] = value
    ...
    def backup_location(self):
        ...
        :rtype: str
        """
        return self.attributes['Ap.Backup Location'] if 'Ap.Backup Location' in self.attributes else None
    ...
    def backup_location(self, value):
        ...
        :type value: str
        """
        self.attributes['Ap.Backup Location'] = value
    ...
    def backup_type(self):
        ...
        :rtype: str
        """
        return self.attributes['Ap.Backup Type'] if 'Ap.Backup Type' in self.attributes else None
    ...
    def backup_type(self, value='File System'):
        ...
        :type value: str
        """
        self.attributes['Ap.Backup Type'] = value
    ...
    def backup_user(self):
        ...
        :rtype: str
        """
        return self.attributes['Ap.Backup User'] if 'Ap.Backup User' in self.attributes else None
    ...
    def backup_user(self, value):
        ...
        :type value: str
        """
        self.attributes['Ap.Backup User'] = value
    ...
    def backup_password(self):
        ...
        :rtype: string
        """
        return self.attributes['Ap.Backup Password'] if 'Ap.Backup Password' in self.attributes else None
    ...
    def backup_password(self, value):
        ...
        :type value: string
        """
        self.attributes['Ap.Backup Password'] = value
...
class ResourcePort(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'Ap.ResourcePort'
        self._name = name
    ...
    def mac_address(self):
        ...
        :rtype: str
        """
        return self.attributes['Ap.ResourcePort.MAC Address'] if 'Ap.ResourcePort.MAC Address' in self.attributes else None
    ...
    def mac_address(self, value=''):
        ...
        :type value: str
        """
        self.attributes['Ap.ResourcePort.MAC Address'] = value
    ...
    def ipv4_address(self):
        ...
        :rtype: str
        """
        return self.attributes['Ap.ResourcePort.IPv4 Address'] if 'Ap.ResourcePort.IPv4 Address' in self.attributes else None
    ...
    def ipv4_address(self, value):
        ...
        :type value: str
        """
        self.attributes['Ap.ResourcePort.IPv4 Address'] = value
    ...
    def ipv6_address(self):
        ...
        :rtype: str
        """
        return self.attributes['Ap.ResourcePort.IPv6 Address'] if 'Ap.ResourcePort.IPv6 Address' in self.attributes else None
    ...
    def ipv6_address(self, value):
        ...
        :type value: str
        """
        self.attributes['Ap.ResourcePort.IPv6 Address'] = value
    ...
    def port_speed(self):
        ...
        :rtype: str
        """
        return self.attributes['Ap.ResourcePort.Port Speed'] if 'Ap.ResourcePort.Port Speed' in self.attributes else None
    ...
    def port_speed(self, value):
        ...
        :type value: str
        """
        self.attributes['Ap.ResourcePort.Port Speed'] = value
...
class GenericPowerPort(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'Ap.GenericPowerPort'
        self._name = name
    ...
    def model(self):
        ...
        :rtype: str
        """
        return self.attributes['Ap.GenericPowerPort.Model'] if 'Ap.GenericPowerPort.Model' in self.attributes else None
    ...
    def model(self, value):
        ...
        :type value: str
        """
        self.attributes['Ap.GenericPowerPort.Model'] = value
    ...
    def serial_number(self):
        ...
        :rtype: str
        """
        return self.attributes['Ap.GenericPowerPort.Serial Number'] if 'Ap.GenericPowerPort.Serial Number' in self.attributes else None
    ...
    def serial_number(self, value):
        ...
        :type value: str
        """
        self.attributes['Ap.GenericPowerPort.Serial Number'] = value
    ...
    def version(self):
        ...
        :rtype: str
        """
        return self.attributes['Ap.GenericPowerPort.Version'] if 'Ap.GenericPowerPort.Version' in self.attributes else None
    ...
    def version(self, value):
        ...
        :type value: str
        """
        self.attributes['Ap.GenericPowerPort.Version'] = value
    ...
    def port_description(self):
        ...
        :rtype: str
        """
        return self.attributes['Ap.GenericPowerPort.Port Description'] if 'Ap.GenericPowerPort.Port Description' in self.attributes else None
    ...
    def port_description(self, value):
        ...
        :type value: str
        """
        self.attributes['Ap.GenericPowerPort.Port Description'] = value
