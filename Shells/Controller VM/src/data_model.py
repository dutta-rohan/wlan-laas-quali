...
class ControllerVm(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'Controller Vm'
        self._name = name
    ...
    def create_from_context(cls, context):
        ...
        :rtype ControllerVm
        """
        result = ControllerVm(name=context.resource.name)
    ...
    def user(self):
        ...
        :rtype: str
        """
        return self.attributes['Controller Vm.User'] if 'Controller Vm.User' in self.attributes else None
    ...
    def user(self, value):
        ...
        :type value: str
        """
        self.attributes['Controller Vm.User'] = value
    ...
    def password(self):
        ...
        :rtype: string
        """
        return self.attributes['Controller Vm.Password'] if 'Controller Vm.Password' in self.attributes else None
    ...
    def password(self, value):
        ...
        :type value: string
        """
        self.attributes['Controller Vm.Password'] = value
    ...
    def enable_password(self):
        ...
        :rtype: string
        """
        return self.attributes['Controller Vm.Enable Password'] if 'Controller Vm.Enable Password' in self.attributes else None
    ...
    def enable_password(self, value):
        ...
        :type value: string
        """
        self.attributes['Controller Vm.Enable Password'] = value
    ...
    def power_management(self):
        ...
        :rtype: bool
        """
        return self.attributes['Controller Vm.Power Management'] if 'Controller Vm.Power Management' in self.attributes else None
    ...
    def power_management(self, value=True):
        ...
        :type value: bool
        """
        self.attributes['Controller Vm.Power Management'] = value
    ...
    def sessions_concurrency_limit(self):
        ...
        :rtype: float
        """
        return self.attributes['Controller Vm.Sessions Concurrency Limit'] if 'Controller Vm.Sessions Concurrency Limit' in self.attributes else None
    ...
    def sessions_concurrency_limit(self, value='1'):
        ...
        :type value: float
        """
        self.attributes['Controller Vm.Sessions Concurrency Limit'] = value
    ...
    def snmp_read_community(self):
        ...
        :rtype: string
        """
        return self.attributes['Controller Vm.SNMP Read Community'] if 'Controller Vm.SNMP Read Community' in self.attributes else None
    ...
    def snmp_read_community(self, value):
        ...
        :type value: string
        """
        self.attributes['Controller Vm.SNMP Read Community'] = value
    ...
    def snmp_write_community(self):
        ...
        :rtype: string
        """
        return self.attributes['Controller Vm.SNMP Write Community'] if 'Controller Vm.SNMP Write Community' in self.attributes else None
    ...
    def snmp_write_community(self, value):
        ...
        :type value: string
        """
        self.attributes['Controller Vm.SNMP Write Community'] = value
    ...
    def snmp_v3_user(self):
        ...
        :rtype: str
        """
        return self.attributes['Controller Vm.SNMP V3 User'] if 'Controller Vm.SNMP V3 User' in self.attributes else None
    ...
    def snmp_v3_user(self, value):
        ...
        :type value: str
        """
        self.attributes['Controller Vm.SNMP V3 User'] = value
    ...
    def snmp_v3_password(self):
        ...
        :rtype: string
        """
        return self.attributes['Controller Vm.SNMP V3 Password'] if 'Controller Vm.SNMP V3 Password' in self.attributes else None
    ...
    def snmp_v3_password(self, value):
        ...
        :type value: string
        """
        self.attributes['Controller Vm.SNMP V3 Password'] = value
    ...
    def snmp_v3_private_key(self):
        ...
        :rtype: str
        """
        return self.attributes['Controller Vm.SNMP V3 Private Key'] if 'Controller Vm.SNMP V3 Private Key' in self.attributes else None
    ...
    def snmp_v3_private_key(self, value):
        ...
        :type value: str
        """
        self.attributes['Controller Vm.SNMP V3 Private Key'] = value
    ...
    def snmp_v3_authentication_protocol(self):
        ...
        :rtype: str
        """
        return self.attributes['Controller Vm.SNMP V3 Authentication Protocol'] if 'Controller Vm.SNMP V3 Authentication Protocol' in self.attributes else None
    ...
    def snmp_v3_authentication_protocol(self, value='No Authentication Protocol'):
        ...
        :type value: str
        """
        self.attributes['Controller Vm.SNMP V3 Authentication Protocol'] = value
    ...
    def snmp_v3_privacy_protocol(self):
        ...
        :rtype: str
        """
        return self.attributes['Controller Vm.SNMP V3 Privacy Protocol'] if 'Controller Vm.SNMP V3 Privacy Protocol' in self.attributes else None
    ...
    def snmp_v3_privacy_protocol(self, value='No Privacy Protocol'):
        ...
        :type value: str
        """
        self.attributes['Controller Vm.SNMP V3 Privacy Protocol'] = value
    ...
    def snmp_version(self):
        ...
        :rtype: str
        """
        return self.attributes['Controller Vm.SNMP Version'] if 'Controller Vm.SNMP Version' in self.attributes else None
    ...
    def snmp_version(self, value=''):
        ...
        :type value: str
        """
        self.attributes['Controller Vm.SNMP Version'] = value
    ...
    def enable_snmp(self):
        ...
        :rtype: bool
        """
        return self.attributes['Controller Vm.Enable SNMP'] if 'Controller Vm.Enable SNMP' in self.attributes else None
    ...
    def enable_snmp(self, value=True):
        ...
        :type value: bool
        """
        self.attributes['Controller Vm.Enable SNMP'] = value
    ...
    def disable_snmp(self):
        ...
        :rtype: bool
        """
        return self.attributes['Controller Vm.Disable SNMP'] if 'Controller Vm.Disable SNMP' in self.attributes else None
    ...
    def disable_snmp(self, value=False):
        ...
        :type value: bool
        """
        self.attributes['Controller Vm.Disable SNMP'] = value
    ...
    def console_server_ip_address(self):
        ...
        :rtype: str
        """
        return self.attributes['Controller Vm.Console Server IP Address'] if 'Controller Vm.Console Server IP Address' in self.attributes else None
    ...
    def console_server_ip_address(self, value):
        ...
        :type value: str
        """
        self.attributes['Controller Vm.Console Server IP Address'] = value
    ...
    def console_user(self):
        ...
        :rtype: str
        """
        return self.attributes['Controller Vm.Console User'] if 'Controller Vm.Console User' in self.attributes else None
    ...
    def console_user(self, value):
        ...
        :type value: str
        """
        self.attributes['Controller Vm.Console User'] = value
    ...
    def console_port(self):
        ...
        :rtype: float
        """
        return self.attributes['Controller Vm.Console Port'] if 'Controller Vm.Console Port' in self.attributes else None
    ...
    def console_port(self, value):
        ...
        :type value: float
        """
        self.attributes['Controller Vm.Console Port'] = value
    ...
    def console_password(self):
        ...
        :rtype: string
        """
        return self.attributes['Controller Vm.Console Password'] if 'Controller Vm.Console Password' in self.attributes else None
    ...
    def console_password(self, value):
        ...
        :type value: string
        """
        self.attributes['Controller Vm.Console Password'] = value
    ...
    def cli_connection_type(self):
        ...
        :rtype: str
        """
        return self.attributes['Controller Vm.CLI Connection Type'] if 'Controller Vm.CLI Connection Type' in self.attributes else None
    ...
    def cli_connection_type(self, value='Auto'):
        ...
        :type value: str
        """
        self.attributes['Controller Vm.CLI Connection Type'] = value
    ...
    def cli_tcp_port(self):
        ...
        :rtype: float
        """
        return self.attributes['Controller Vm.CLI TCP Port'] if 'Controller Vm.CLI TCP Port' in self.attributes else None
    ...
    def cli_tcp_port(self, value):
        ...
        :type value: float
        """
        self.attributes['Controller Vm.CLI TCP Port'] = value
    ...
    def backup_location(self):
        ...
        :rtype: str
        """
        return self.attributes['Controller Vm.Backup Location'] if 'Controller Vm.Backup Location' in self.attributes else None
    ...
    def backup_location(self, value):
        ...
        :type value: str
        """
        self.attributes['Controller Vm.Backup Location'] = value
    ...
    def backup_type(self):
        ...
        :rtype: str
        """
        return self.attributes['Controller Vm.Backup Type'] if 'Controller Vm.Backup Type' in self.attributes else None
    ...
    def backup_type(self, value='File System'):
        ...
        :type value: str
        """
        self.attributes['Controller Vm.Backup Type'] = value
    ...
    def backup_user(self):
        ...
        :rtype: str
        """
        return self.attributes['Controller Vm.Backup User'] if 'Controller Vm.Backup User' in self.attributes else None
    ...
    def backup_user(self, value):
        ...
        :type value: str
        """
        self.attributes['Controller Vm.Backup User'] = value
    ...
    def backup_password(self):
        ...
        :rtype: string
        """
        return self.attributes['Controller Vm.Backup Password'] if 'Controller Vm.Backup Password' in self.attributes else None
    ...
    def backup_password(self, value):
        ...
        :type value: string
        """
        self.attributes['Controller Vm.Backup Password'] = value
...
class ResourcePort(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'Controller Vm.ResourcePort'
        self._name = name
    ...
    def mac_address(self):
        ...
        :rtype: str
        """
        return self.attributes['Controller Vm.ResourcePort.MAC Address'] if 'Controller Vm.ResourcePort.MAC Address' in self.attributes else None
    ...
    def mac_address(self, value=''):
        ...
        :type value: str
        """
        self.attributes['Controller Vm.ResourcePort.MAC Address'] = value
    ...
    def ipv4_address(self):
        ...
        :rtype: str
        """
        return self.attributes['Controller Vm.ResourcePort.IPv4 Address'] if 'Controller Vm.ResourcePort.IPv4 Address' in self.attributes else None
    ...
    def ipv4_address(self, value):
        ...
        :type value: str
        """
        self.attributes['Controller Vm.ResourcePort.IPv4 Address'] = value
    ...
    def ipv6_address(self):
        ...
        :rtype: str
        """
        return self.attributes['Controller Vm.ResourcePort.IPv6 Address'] if 'Controller Vm.ResourcePort.IPv6 Address' in self.attributes else None
    ...
    def ipv6_address(self, value):
        ...
        :type value: str
        """
        self.attributes['Controller Vm.ResourcePort.IPv6 Address'] = value
    ...
    def port_speed(self):
        ...
        :rtype: str
        """
        return self.attributes['Controller Vm.ResourcePort.Port Speed'] if 'Controller Vm.ResourcePort.Port Speed' in self.attributes else None
    ...
    def port_speed(self, value):
        ...
        :type value: str
        """
        self.attributes['Controller Vm.ResourcePort.Port Speed'] = value
...
class GenericPowerPort(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'Controller Vm.GenericPowerPort'
        self._name = name
    ...
    def model(self):
        ...
        :rtype: str
        """
        return self.attributes['Controller Vm.GenericPowerPort.Model'] if 'Controller Vm.GenericPowerPort.Model' in self.attributes else None
    ...
    def model(self, value):
        ...
        :type value: str
        """
        self.attributes['Controller Vm.GenericPowerPort.Model'] = value
    ...
    def serial_number(self):
        ...
        :rtype: str
        """
        return self.attributes['Controller Vm.GenericPowerPort.Serial Number'] if 'Controller Vm.GenericPowerPort.Serial Number' in self.attributes else None
    ...
    def serial_number(self, value):
        ...
        :type value: str
        """
        self.attributes['Controller Vm.GenericPowerPort.Serial Number'] = value
    ...
    def version(self):
        ...
        :rtype: str
        """
        return self.attributes['Controller Vm.GenericPowerPort.Version'] if 'Controller Vm.GenericPowerPort.Version' in self.attributes else None
    ...
    def version(self, value):
        ...
        :type value: str
        """
        self.attributes['Controller Vm.GenericPowerPort.Version'] = value
    ...
    def port_description(self):
        ...
        :rtype: str
        """
        return self.attributes['Controller Vm.GenericPowerPort.Port Description'] if 'Controller Vm.GenericPowerPort.Port Description' in self.attributes else None
    ...
    def port_description(self, value):
        ...
        :type value: str
        """
        self.attributes['Controller Vm.GenericPowerPort.Port Description'] = value
